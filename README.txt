...
This is the readme for ProjectOne, try to keep it up to date with any information future-you will wish past-you
...
- File > Open > select the top level folder of this project ( i.e. ProjectOne) > Ok.
...
- To run the project find ProjectOne.java (which will be in under src/main/java/com/stasio) and right click > Run 'ProjectOne'
